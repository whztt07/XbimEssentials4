		...
		public  override void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				...
				case 6: 
					...
					return;
				case 7: 
					if (_category == null) _category = new ItemSet<CobiePickKeyValue>( Model );
					_category.Add((CobiePickKeyValue)value.EntityVal);
					return;
				case 8: 
					if (_impacts == null) _impacts = new ItemSet<CobieImpact>( Model );
					_impacts.Add((CobieImpact)value.EntityVal);
					return;
				case 9: 
					if (_documents == null) _documents = new ItemSet<CobieDocument>( Model );
					_documents.Add((CobieDocument)value.EntityVal);
					return;
				case 10: 
					if (_attributes == null) _attributes = new ItemSet<CobieAttribute>( Model );
					_attributes.Add((CobieAttribute)value.EntityVal);
					return;
				default:
