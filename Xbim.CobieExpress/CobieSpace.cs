...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieSpace : CobieAsset, SpatialDivision, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _roomTag;
		...
		{ 
			get 
			{
				if(IsActivated) return _usableHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _grossArea;
		...
		{ 
			get 
			{
				if(IsActivated) return _netArea;
