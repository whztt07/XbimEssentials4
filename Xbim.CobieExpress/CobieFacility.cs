...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieFacility : CobieAsset, SpatialDivision, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _linearUnits;
		...
		{ 
			get 
			{
				if(IsActivated) return _areaUnits;
		...
		{ 
			get 
			{
				if(IsActivated) return _volumeUnits;
		...
		{ 
			get 
			{
				if(IsActivated) return _currencyUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _areaMeasurement;
