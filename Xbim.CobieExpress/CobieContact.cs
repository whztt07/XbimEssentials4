...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieContact : CobieExternalReference, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _company;
		...
		{ 
			get 
			{
				if(IsActivated) return _department;
		...
		{ 
			get 
			{
				if(IsActivated) return _organizationCode;
		...
		{ 
			get 
			{
				if(IsActivated) return _postalBox;
		...
		{ 
			get 
			{
				if(IsActivated) return _stateRegion;
		...
		{ 
			get 
			{
				if(IsActivated) return _postalCode;
		...
		{ 
			get 
			{
				if(IsActivated) return _country;
