...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieComponent : CobieAsset, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _serialNumber;
		...
		{ 
			get 
			{
				if(IsActivated) return _installationDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _warrantyStartDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _tagNumber;
		...
		{ 
			get 
			{
				if(IsActivated) return _barCode;
		...
		{ 
			get 
			{
				if(IsActivated) return _assetIdentifier;
