...
namespace Xbim.CobieExpress
{
	public sealed class EntityFactory : IEntityFactory
	{
		...
		public IInstantiableEntity New(IModel model, int typeId, int entityLabel, bool activated)
		{
			...
			switch(typeId)
			{
				case 0: return new CobiePickList ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 1: return new CobiePickValue ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 2: return new CobiePickKeyValue ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 3: return new CobiePhase ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 4: return new CobieExternalSystem ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 5: return new CobieCreatedInfo ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 7: return new CobieContact ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 9: return new CobieFacility ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 10: return new CobieProject ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 11: return new CobieSite ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 12: return new CobieFloor ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 13: return new CobieSpace ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 14: return new CobieZone ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 15: return new CobieType ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 16: return new CobieWarranty ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 17: return new CobieComponent ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 18: return new CobieSystem ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 19: return new CobieConnection ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 20: return new CobieSpare ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 21: return new CobieResource ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 22: return new CobieJob ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 23: return new CobieImpact ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 24: return new CobieDocument ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 25: return new CobieAttribute ( model ) { Activated = activated, EntityLabel = entityLabel };
				case 26: return new CobieIssue ( model ) { Activated = activated, EntityLabel = entityLabel };
				default:
					return null;
			}
		}
