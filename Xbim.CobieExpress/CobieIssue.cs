...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieIssue : CobieExternalReference, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _issueType;
		...
		{ 
			get 
			{
				if(IsActivated) return _mitigation;
		...
		{ 
			get 
			{
				if(IsActivated) return _causing;
		...
		{ 
			get 
			{
				if(IsActivated) return _affected;
