...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieJob : CobieExternalReference, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _taskNumber;
		...
		{ 
			get 
			{
				if(IsActivated) return _jobType;
		...
		{ 
			get 
			{
				if(IsActivated) return _jobStatusType;
		...
		{ 
			get 
			{
				if(IsActivated) return _startUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _frequency;
		...
		{ 
			get 
			{
				if(IsActivated) return _frequencyUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _resources;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 11:
					 ...
					 break;
				case 12:
					 if (value != null) @Start = (float)value;
					 break;
				case 13:
					 @StartUnit = (CobiePickValue)value;
					 break;
				case 14:
					 if (value != null) @Frequency = (float)value;
					 break;
				case 15:
