		...
		public  override void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				...
				case 32: 
					...
					return;
				case 33: 
					if (_assemblyOf == null) _assemblyOf = new ItemSet<CobieType>( Model );
					_assemblyOf.Add((CobieType)value.EntityVal);
					return;
				case 34: 
					if (_jobs == null) _jobs = new ItemSet<CobieJob>( Model );
					_jobs.Add((CobieJob)value.EntityVal);
					return;
				default:
