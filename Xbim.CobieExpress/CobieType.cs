...
namespace Xbim.CobieExpress
{
	...
	public  partial class @CobieType : CobieAsset, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _assetType;
		...
		{ 
			get 
			{
				if(IsActivated) return _manufacturer;
		...
		{ 
			get 
			{
				if(IsActivated) return _modelNumber;
		...
		{ 
			get 
			{
				if(IsActivated) return _warranty;
		...
		{ 
			get 
			{
				if(IsActivated) return _replacementCost;
		...
		{ 
			get 
			{
				if(IsActivated) return _expectedLife;
		...
		{ 
			get 
			{
				if(IsActivated) return _durationUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _nominalLength;
		...
		{ 
			get 
			{
				if(IsActivated) return _nominalWidth;
		...
		{ 
			get 
			{
				if(IsActivated) return _nominalHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _modelReference;
		...
		{ 
			get 
			{
				if(IsActivated) return _constituents;
		...
		{ 
			get 
			{
				if(IsActivated) return _features;
		...
		{ 
			get 
			{
				if(IsActivated) return _accessibilityPerformance;
		...
		{ 
			get 
			{
				if(IsActivated) return _codePerformance;
		...
		{ 
			get 
			{
				if(IsActivated) return _sustainabilityPerformance;
		...
		{ 
			get 
			{
				if(IsActivated) return _assemblyOf;
