...
{
	[EntityName("IFCFLUIDFLOWPROPERTIES")]
	public  partial class @IfcFluidFlowProperties : IfcPropertySetDefinition, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _flowConditionTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _velocityTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _flowrateTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _pressureTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _temperatureSingleValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _wetBulbTemperatureSingleValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _wetBulbTemperatureTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _temperatureTimeSeries;
		...
		{ 
			get 
			{
				if(IsActivated) return _flowrateSingleValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _flowConditionSingleValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _velocitySingleValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _pressureSingleValue;
