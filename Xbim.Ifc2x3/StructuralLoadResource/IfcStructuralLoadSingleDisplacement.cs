...
{
	[EntityName("IFCSTRUCTURALLOADSINGLEDISPLACEMENT")]
	public  partial class @IfcStructuralLoadSingleDisplacement : IfcStructuralLoadStatic, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _displacementX;
		...
		{ 
			get 
			{
				if(IsActivated) return _displacementY;
		...
		{ 
			get 
			{
				if(IsActivated) return _displacementZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalDisplacementRX;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalDisplacementRY;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalDisplacementRZ;
