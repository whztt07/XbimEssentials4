...
{
	[EntityName("IFCPHYSICALCOMPLEXQUANTITY")]
	public  partial class @IfcPhysicalComplexQuantity : IfcPhysicalQuantity, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _hasQuantities;
		...
		{ 
			get 
			{
				if(IsActivated) return _discrimination;
		...
		{ 
			get 
			{
				if(IsActivated) return _quality;
