...
namespace Xbim.Ifc2x3.ArchitectureDomain
{
	...
	public  partial class @IfcSpaceProgram : IfcControl, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _spaceProgramIdentifier;
		...
		{ 
			get 
			{
				if(IsActivated) return _maxRequiredArea;
		...
		{ 
			get 
			{
				if(IsActivated) return _minRequiredArea;
		...
		{ 
			get 
			{
				if(IsActivated) return _requestedLocation;
		...
		{ 
			get 
			{
				if(IsActivated) return _standardRequiredArea;
