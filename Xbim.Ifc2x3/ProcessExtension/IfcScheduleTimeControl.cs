...
{
	[EntityName("IFCSCHEDULETIMECONTROL")]
	public  partial class @IfcScheduleTimeControl : IfcControl, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _earlyStart;
		...
		{ 
			get 
			{
				if(IsActivated) return _lateStart;
		...
		{ 
			get 
			{
				if(IsActivated) return _earlyFinish;
		...
		{ 
			get 
			{
				if(IsActivated) return _lateFinish;
		...
		{ 
			get 
			{
				if(IsActivated) return _scheduleDuration;
		...
		{ 
			get 
			{
				if(IsActivated) return _actualDuration;
		...
		{ 
			get 
			{
				if(IsActivated) return _remainingTime;
		...
		{ 
			get 
			{
				if(IsActivated) return _freeFloat;
		...
		{ 
			get 
			{
				if(IsActivated) return _isCritical;
		...
		{ 
			get 
			{
				if(IsActivated) return _startFloat;
		...
		{ 
			get 
			{
				if(IsActivated) return _finishFloat;
