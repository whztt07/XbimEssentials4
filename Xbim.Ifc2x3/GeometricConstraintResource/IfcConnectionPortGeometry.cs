...
{
	[EntityName("IFCCONNECTIONPORTGEOMETRY")]
	public  partial class @IfcConnectionPortGeometry : IfcConnectionGeometry, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _locationAtRelatingElement;
		...
		{ 
			get 
			{
				if(IsActivated) return _locationAtRelatedElement;
		...
		{ 
			get 
			{
				if(IsActivated) return _profileOfPort;
