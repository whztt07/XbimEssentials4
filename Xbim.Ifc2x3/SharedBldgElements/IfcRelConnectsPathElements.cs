...
namespace Xbim.Ifc2x3.SharedBldgElements
{
	...
	public  partial class @IfcRelConnectsPathElements : IfcRelConnectsElements, IInstantiableEntity
	{
		...
		internal IfcRelConnectsPathElements(IModel model) : base(model) 		{ 
			Model = model; 
			_relatingPriorities = new ItemSet<int>( model );
			_relatedPriorities = new ItemSet<int>( model );
		}

		#region Explicit attribute fields
		private ItemSet<int> _relatingPriorities;
		private ItemSet<int> _relatedPriorities;
		...
		public ItemSet<int> @RelatingPriorities 
		{ 
			get 
			{
		...
		public ItemSet<int> @RelatedPriorities 
		{ 
			get 
			{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 6:
					 ...
					 break;
				case 7:
					 @RelatingPriorities.Add((int)value);
					 break;
				case 8:
					 @RelatedPriorities.Add((int)value);
					 break;
				case 9:
