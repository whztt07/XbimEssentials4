...
{
	[EntityName("IFCELEMENTQUANTITY")]
	public  partial class @IfcElementQuantity : IfcPropertySetDefinition, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _methodOfMeasurement;
		...
		{ 
			get 
			{
				if(IsActivated) return _quantities;
