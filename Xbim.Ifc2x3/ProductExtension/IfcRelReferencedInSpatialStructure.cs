...
{
	[EntityName("IFCRELREFERENCEDINSPATIALSTRUCTURE")]
	public  partial class @IfcRelReferencedInSpatialStructure : IfcRelConnects, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _relatedElements;
		...
		{ 
			get 
			{
				if(IsActivated) return _relatingStructure;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 4:
					 ...
					 break;
				case 5:
					 @RelatingStructure = (IfcSpatialStructureElement)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
