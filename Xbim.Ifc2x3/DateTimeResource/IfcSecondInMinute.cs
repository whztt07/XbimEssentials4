...
namespace Xbim.Ifc2x3.DateTimeResource
{
	...
	{ 
        ...
        public IfcSecondInMinute(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSecondInMinute(float value)
        {
            return new IfcSecondInMinute(value);
        }

        public static implicit operator float(IfcSecondInMinute obj)
        {
