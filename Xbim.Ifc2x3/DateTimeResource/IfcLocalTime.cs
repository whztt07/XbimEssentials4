...
namespace Xbim.Ifc2x3.DateTimeResource
{
	...
	public  partial class @IfcLocalTime : INotifyPropertyChanged, IfcDateTimeSelect, IfcObjectReferenceSelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _hourComponent;
		...
		{ 
			get 
			{
				if(IsActivated) return _minuteComponent;
		...
		{ 
			get 
			{
				if(IsActivated) return _secondComponent;
		...
		{ 
			get 
			{
				if(IsActivated) return _daylightSavingOffset;
