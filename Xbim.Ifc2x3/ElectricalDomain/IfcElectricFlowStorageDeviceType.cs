...
{
	[EntityName("IFCELECTRICFLOWSTORAGEDEVICETYPE", 372)]
	public  partial class @IfcElectricFlowStorageDeviceType : IfcFlowStorageDeviceType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcElectricFlowStorageDeviceTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
