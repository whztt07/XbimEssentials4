...
{
	[EntityName("IFCOPTICALMATERIALPROPERTIES")]
	public  partial class @IfcOpticalMaterialProperties : IfcMaterialProperties, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _visibleTransmittance;
		...
		{ 
			get 
			{
				if(IsActivated) return _solarTransmittance;
		...
		{ 
			get 
			{
				if(IsActivated) return _thermalIrTransmittance;
		...
		{ 
			get 
			{
				if(IsActivated) return _thermalIrEmissivityBack;
		...
		{ 
			get 
			{
				if(IsActivated) return _thermalIrEmissivityFront;
		...
		{ 
			get 
			{
				if(IsActivated) return _visibleReflectanceBack;
		...
		{ 
			get 
			{
				if(IsActivated) return _visibleReflectanceFront;
		...
		{ 
			get 
			{
				if(IsActivated) return _solarReflectanceFront;
		...
		{ 
			get 
			{
				if(IsActivated) return _solarReflectanceBack;
