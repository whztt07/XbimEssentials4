...
namespace Xbim.Ifc2x3.MaterialPropertyResource
{
	...
	public  partial class @IfcWaterProperties : IfcMaterialProperties, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _isPotable;
		...
		{ 
			get 
			{
				if(IsActivated) return _hardness;
		...
		{ 
			get 
			{
				if(IsActivated) return _alkalinityConcentration;
		...
		{ 
			get 
			{
				if(IsActivated) return _acidityConcentration;
		...
		{ 
			get 
			{
				if(IsActivated) return _impuritiesContent;
		...
		{ 
			get 
			{
				if(IsActivated) return _pHLevel;
		...
		{ 
			get 
			{
				if(IsActivated) return _dissolvedSolidsContent;
