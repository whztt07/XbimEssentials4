...
namespace Xbim.Ifc2x3.MaterialPropertyResource
{
	...
	public  partial class @IfcFuelProperties : IfcMaterialProperties, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _combustionTemperature;
		...
		{ 
			get 
			{
				if(IsActivated) return _carbonContent;
		...
		{ 
			get 
			{
				if(IsActivated) return _lowerHeatingValue;
		...
		{ 
			get 
			{
				if(IsActivated) return _higherHeatingValue;
