...
namespace Xbim.Ifc2x3.SharedMgmtElements
{
	...
	public  partial class @IfcCostSchedule : IfcControl, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _submittedBy;
		...
		{ 
			get 
			{
				if(IsActivated) return _preparedBy;
		...
		{ 
			get 
			{
				if(IsActivated) return _submittedOn;
		...
		{ 
			get 
			{
				if(IsActivated) return _targetUsers;
		...
		{ 
			get 
			{
				if(IsActivated) return _updateDate;
