		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_secondaryPlaneAngle == null) _secondaryPlaneAngle = new ItemSet<IfcPlaneAngleMeasure>( Model );
					_secondaryPlaneAngle.Add(value.RealVal);
					return;
				case 2: 
					if (_luminousIntensity == null) _luminousIntensity = new ItemSet<IfcLuminousIntensityDistributionMeasure>( Model );
