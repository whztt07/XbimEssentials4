...
{
	[EntityName("IFCPRESENTATIONLAYERWITHSTYLE")]
	public  partial class @IfcPresentationLayerWithStyle : IfcPresentationLayerAssignment, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _layerOn;
		...
		{ 
			get 
			{
				if(IsActivated) return _layerFrozen;
		...
		{ 
			get 
			{
				if(IsActivated) return _layerBlocked;
		...
		{ 
			get 
			{
				if(IsActivated) return _layerStyles;
