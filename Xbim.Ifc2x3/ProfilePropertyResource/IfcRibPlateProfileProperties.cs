...
{
	[EntityName("IFCRIBPLATEPROFILEPROPERTIES")]
	public  partial class @IfcRibPlateProfileProperties : IfcProfileProperties, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _ribHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _ribWidth;
		...
		{ 
			get 
			{
				if(IsActivated) return _ribSpacing;
		...
		{ 
			get 
			{
				if(IsActivated) return _direction;
