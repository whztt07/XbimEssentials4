...
{
	[EntityName("IFCSTRUCTURALPROFILEPROPERTIES")]
	public  partial class @IfcStructuralProfileProperties : IfcGeneralProfileProperties, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _torsionalConstantX;
		...
		{ 
			get 
			{
				if(IsActivated) return _momentOfInertiaYZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _momentOfInertiaY;
		...
		{ 
			get 
			{
				if(IsActivated) return _momentOfInertiaZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _warpingConstant;
		...
		{ 
			get 
			{
				if(IsActivated) return _shearCentreZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _shearCentreY;
		...
		{ 
			get 
			{
				if(IsActivated) return _shearDeformationAreaZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _shearDeformationAreaY;
		...
		{ 
			get 
			{
				if(IsActivated) return _maximumSectionModulusY;
		...
		{ 
			get 
			{
				if(IsActivated) return _minimumSectionModulusY;
		...
		{ 
			get 
			{
				if(IsActivated) return _maximumSectionModulusZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _minimumSectionModulusZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _torsionalSectionModulus;
		...
		{ 
			get 
			{
				if(IsActivated) return _centreOfGravityInX;
