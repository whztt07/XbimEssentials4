...
namespace Xbim.Ifc2x3.ActorResource
{
	...
	public  partial class @IfcPerson : INotifyPropertyChanged, IfcActorSelect, IfcObjectReferenceSelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _familyName;
		...
		{ 
			get 
			{
				if(IsActivated) return _givenName;
		...
		{ 
			get 
			{
				if(IsActivated) return _middleNames;
		...
		{ 
			get 
			{
				if(IsActivated) return _prefixTitles;
		...
		{ 
			get 
			{
				if(IsActivated) return _suffixTitles;
		...
		{ 
			get 
			{
				if(IsActivated) return _addresses;
