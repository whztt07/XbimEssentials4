...
{
	[EntityName("IFCORGANIZATIONRELATIONSHIP", 486)]
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				...
				case 2: 
					...
					return;
				case 3: 
					if (_relatedOrganizations == null) _relatedOrganizations = new ItemSet<IfcOrganization>( Model );
					_relatedOrganizations.Add((IfcOrganization)value.EntityVal);
					return;
				default:
