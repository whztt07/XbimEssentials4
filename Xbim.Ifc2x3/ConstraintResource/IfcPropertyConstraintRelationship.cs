...
namespace Xbim.Ifc2x3.ConstraintResource
{
	...
	public  partial class @IfcPropertyConstraintRelationship : IPersistEntity, INotifyPropertyChanged, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcPropertyConstraintRelationship>, System.IEquatable<@IfcPropertyConstraintRelationship>
	{
		...
		internal IfcPropertyConstraintRelationship(IModel model) 		{ 
			Model = model; 
			_relatedProperties = new ItemSet<IfcProperty>( this );
		}
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_relatedProperties == null) _relatedProperties = new ItemSet<IfcProperty>( this );
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcPropertyConstraintRelationship
            var root = (@IfcPropertyConstraintRelationship)obj;
            return this == root;
        }
