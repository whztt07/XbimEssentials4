...
namespace Xbim.Ifc2x3.ConstraintResource
{
	...
	public  partial class @IfcConstraintClassificationRelationship : INotifyPropertyChanged, IInstantiableEntity
	{
		...
		internal IfcConstraintClassificationRelationship(IModel model) 		{ 
			Model = model; 
			_relatedClassifications = new ItemSet<IfcClassificationNotationSelect>( model );
		}
		...
		object IInstantiableEntity.GetValue(string name)
		{
			switch(name)
			{
				case "ClassifiedConstraint":  
					return @ClassifiedConstraint;
				case "RelatedClassifications":  
					return @RelatedClassifications;
				default:
					throw new System.IndexOutOfRangeException();
			}
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			...
			{
				case 0:
					 @ClassifiedConstraint = (IfcConstraint)value;
					 break;
				case 1:
					 @RelatedClassifications.Add((IfcClassificationNotationSelect)value);
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_relatedClassifications == null) _relatedClassifications = new ItemSet<IfcClassificationNotationSelect>( Model );
					_relatedClassifications.Add((IfcClassificationNotationSelect)value.EntityVal);
					return;
				default:
