...
{
	public partial struct IfcRatioMeasure : IfcAppliedValueSelect, IfcMeasureValue, IfcSizeSelect, IExpressSelectType
	{ 
        ...
        public IfcRatioMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcRatioMeasure(float value)
        {
            return new IfcRatioMeasure(value);
        }

        public static implicit operator float(IfcRatioMeasure obj)
        {
