...
{
	public partial struct IfcMolecularWeightMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcMolecularWeightMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcMolecularWeightMeasure(float value)
        {
            return new IfcMolecularWeightMeasure(value);
        }

        public static implicit operator float(IfcMolecularWeightMeasure obj)
        {
