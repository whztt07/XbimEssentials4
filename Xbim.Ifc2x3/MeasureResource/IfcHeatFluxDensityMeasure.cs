...
{
	public partial struct IfcHeatFluxDensityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcHeatFluxDensityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcHeatFluxDensityMeasure(float value)
        {
            return new IfcHeatFluxDensityMeasure(value);
        }

        public static implicit operator float(IfcHeatFluxDensityMeasure obj)
        {
