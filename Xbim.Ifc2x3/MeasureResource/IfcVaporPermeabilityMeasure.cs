...
{
	public partial struct IfcVaporPermeabilityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcVaporPermeabilityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcVaporPermeabilityMeasure(float value)
        {
            return new IfcVaporPermeabilityMeasure(value);
        }

        public static implicit operator float(IfcVaporPermeabilityMeasure obj)
        {
