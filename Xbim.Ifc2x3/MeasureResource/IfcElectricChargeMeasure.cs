...
namespace Xbim.Ifc2x3.MeasureResource
{
	...
	{ 
        ...
        public IfcElectricChargeMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcElectricChargeMeasure(float value)
        {
            return new IfcElectricChargeMeasure(value);
        }

        public static implicit operator float(IfcElectricChargeMeasure obj)
        {
