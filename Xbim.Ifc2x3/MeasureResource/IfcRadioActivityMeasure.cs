...
{
	public partial struct IfcRadioActivityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcRadioActivityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcRadioActivityMeasure(float value)
        {
            return new IfcRadioActivityMeasure(value);
        }

        public static implicit operator float(IfcRadioActivityMeasure obj)
        {
