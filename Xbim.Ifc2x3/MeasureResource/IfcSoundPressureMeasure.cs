...
{
	public partial struct IfcSoundPressureMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcSoundPressureMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSoundPressureMeasure(float value)
        {
            return new IfcSoundPressureMeasure(value);
        }

        public static implicit operator float(IfcSoundPressureMeasure obj)
        {
