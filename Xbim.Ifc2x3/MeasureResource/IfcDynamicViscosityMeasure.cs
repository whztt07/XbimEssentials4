...
{
	public partial struct IfcDynamicViscosityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcDynamicViscosityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcDynamicViscosityMeasure(float value)
        {
            return new IfcDynamicViscosityMeasure(value);
        }

        public static implicit operator float(IfcDynamicViscosityMeasure obj)
        {
