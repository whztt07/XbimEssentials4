...
{
	public partial struct IfcIsothermalMoistureCapacityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcIsothermalMoistureCapacityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcIsothermalMoistureCapacityMeasure(float value)
        {
            return new IfcIsothermalMoistureCapacityMeasure(value);
        }

        public static implicit operator float(IfcIsothermalMoistureCapacityMeasure obj)
        {
