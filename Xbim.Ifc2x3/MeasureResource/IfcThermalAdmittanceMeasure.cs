...
{
	public partial struct IfcThermalAdmittanceMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcThermalAdmittanceMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcThermalAdmittanceMeasure(float value)
        {
            return new IfcThermalAdmittanceMeasure(value);
        }

        public static implicit operator float(IfcThermalAdmittanceMeasure obj)
        {
