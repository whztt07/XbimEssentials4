...
{
	public partial struct IfcRotationalMassMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcRotationalMassMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcRotationalMassMeasure(float value)
        {
            return new IfcRotationalMassMeasure(value);
        }

        public static implicit operator float(IfcRotationalMassMeasure obj)
        {
