...
{
	public partial struct IfcMomentOfInertiaMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcMomentOfInertiaMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcMomentOfInertiaMeasure(float value)
        {
            return new IfcMomentOfInertiaMeasure(value);
        }

        public static implicit operator float(IfcMomentOfInertiaMeasure obj)
        {
