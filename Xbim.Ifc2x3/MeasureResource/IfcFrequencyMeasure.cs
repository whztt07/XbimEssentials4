...
{
	public partial struct IfcFrequencyMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcFrequencyMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcFrequencyMeasure(float value)
        {
            return new IfcFrequencyMeasure(value);
        }

        public static implicit operator float(IfcFrequencyMeasure obj)
        {
