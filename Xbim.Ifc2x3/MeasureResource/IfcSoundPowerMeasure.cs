...
namespace Xbim.Ifc2x3.MeasureResource
{
	...
	{ 
        ...
        public IfcSoundPowerMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSoundPowerMeasure(float value)
        {
            return new IfcSoundPowerMeasure(value);
        }

        public static implicit operator float(IfcSoundPowerMeasure obj)
        {
