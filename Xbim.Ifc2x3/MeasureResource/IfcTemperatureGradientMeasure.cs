...
{
	public partial struct IfcTemperatureGradientMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcTemperatureGradientMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcTemperatureGradientMeasure(float value)
        {
            return new IfcTemperatureGradientMeasure(value);
        }

        public static implicit operator float(IfcTemperatureGradientMeasure obj)
        {
