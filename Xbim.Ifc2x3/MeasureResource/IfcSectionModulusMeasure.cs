...
{
	public partial struct IfcSectionModulusMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcSectionModulusMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSectionModulusMeasure(float value)
        {
            return new IfcSectionModulusMeasure(value);
        }

        public static implicit operator float(IfcSectionModulusMeasure obj)
        {
