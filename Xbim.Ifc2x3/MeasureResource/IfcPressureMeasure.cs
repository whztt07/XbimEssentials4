...
{
	public partial struct IfcPressureMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcPressureMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcPressureMeasure(float value)
        {
            return new IfcPressureMeasure(value);
        }

        public static implicit operator float(IfcPressureMeasure obj)
        {
