...
namespace Xbim.Ifc2x3.MeasureResource
{
	...
	{ 
        ...
        public IfcTorqueMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcTorqueMeasure(float value)
        {
            return new IfcTorqueMeasure(value);
        }

        public static implicit operator float(IfcTorqueMeasure obj)
        {
