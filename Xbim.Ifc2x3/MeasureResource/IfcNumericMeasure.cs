...
{
	public partial struct IfcNumericMeasure : IfcMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcNumericMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcNumericMeasure(float value)
        {
            return new IfcNumericMeasure(value);
        }

        public static implicit operator float(IfcNumericMeasure obj)
        {
