...
{
	public partial struct IfcAngularVelocityMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcAngularVelocityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcAngularVelocityMeasure(float value)
        {
            return new IfcAngularVelocityMeasure(value);
        }

        public static implicit operator float(IfcAngularVelocityMeasure obj)
        {
