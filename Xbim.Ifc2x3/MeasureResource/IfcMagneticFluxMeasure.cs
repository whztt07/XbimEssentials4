...
{
	public partial struct IfcMagneticFluxMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcMagneticFluxMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcMagneticFluxMeasure(float value)
        {
            return new IfcMagneticFluxMeasure(value);
        }

        public static implicit operator float(IfcMagneticFluxMeasure obj)
        {
