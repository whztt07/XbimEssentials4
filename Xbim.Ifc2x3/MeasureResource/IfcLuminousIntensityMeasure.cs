...
{
	public partial struct IfcLuminousIntensityMeasure : IfcMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcLuminousIntensityMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcLuminousIntensityMeasure(float value)
        {
            return new IfcLuminousIntensityMeasure(value);
        }

        public static implicit operator float(IfcLuminousIntensityMeasure obj)
        {
