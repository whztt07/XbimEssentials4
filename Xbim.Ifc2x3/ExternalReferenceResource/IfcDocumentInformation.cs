...
{
	[EntityName("IFCDOCUMENTINFORMATION")]
	public  partial class @IfcDocumentInformation : INotifyPropertyChanged, IfcDocumentSelect, IInstantiableEntity
	{
		...
		internal IfcDocumentInformation(IModel model) 		{ 
			Model = model; 
			_documentReferences = new ItemSet<IfcDocumentReference>( model );
		...
		{ 
			get 
			{
				if(IsActivated) return _documentId;
		...
		{ 
			get 
			{
				if(IsActivated) return _documentReferences;
		...
		{ 
			get 
			{
				if(IsActivated) return _intendedUse;
		...
		{ 
			get 
			{
				if(IsActivated) return _revision;
		...
		{ 
			get 
			{
				if(IsActivated) return _documentOwner;
		...
		{ 
			get 
			{
				if(IsActivated) return _editors;
		...
		{ 
			get 
			{
				if(IsActivated) return _lastRevisionTime;
		...
		{ 
			get 
			{
				if(IsActivated) return _electronicFormat;
		...
		{ 
			get 
			{
				if(IsActivated) return _validFrom;
		...
		{ 
			get 
			{
				if(IsActivated) return _validUntil;
		...
		{ 
			get 
			{
				if(IsActivated) return _confidentiality;
