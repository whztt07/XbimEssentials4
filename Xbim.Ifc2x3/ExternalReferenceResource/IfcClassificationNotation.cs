...
namespace Xbim.Ifc2x3.ExternalReferenceResource
{
	...
	public  partial class @IfcClassificationNotation : INotifyPropertyChanged, IfcClassificationNotationSelect, IInstantiableEntity
	{
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			...
			{
				case 0: 
					if (_notationFacets == null) _notationFacets = new ItemSet<IfcClassificationNotationFacet>( Model );
					_notationFacets.Add((IfcClassificationNotationFacet)value.EntityVal);
					return;
				default:
