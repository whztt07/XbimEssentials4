...
{
	[EntityName("IFCLIBRARYINFORMATION")]
	public  partial class @IfcLibraryInformation : INotifyPropertyChanged, IfcLibrarySelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _version;
		...
		{ 
			get 
			{
				if(IsActivated) return _publisher;
		...
		{ 
			get 
			{
				if(IsActivated) return _versionDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _libraryReference;
