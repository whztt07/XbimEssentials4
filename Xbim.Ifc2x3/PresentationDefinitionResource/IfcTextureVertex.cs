...
{
	[EntityName("IFCTEXTUREVERTEX", 735)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcTextureVertex : INotifyPropertyChanged, IInstantiableEntity
	{
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			...
			{
				case 0: 
					if (_coordinates == null) _coordinates = new ItemSet<IfcParameterValue>( Model );
