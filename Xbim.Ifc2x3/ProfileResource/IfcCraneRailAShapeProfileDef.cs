...
{
	[EntityName("IFCCRANERAILASHAPEPROFILEDEF")]
	public  partial class @IfcCraneRailAShapeProfileDef : IfcParameterizedProfileDef, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _overallHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _baseWidth2;
		...
		{ 
			get 
			{
				if(IsActivated) return _headWidth;
		...
		{ 
			get 
			{
				if(IsActivated) return _headDepth2;
		...
		{ 
			get 
			{
				if(IsActivated) return _headDepth3;
		...
		{ 
			get 
			{
				if(IsActivated) return _baseWidth4;
		...
		{ 
			get 
			{
				if(IsActivated) return _baseDepth1;
		...
		{ 
			get 
			{
				if(IsActivated) return _baseDepth2;
		...
		{ 
			get 
			{
				if(IsActivated) return _baseDepth3;
