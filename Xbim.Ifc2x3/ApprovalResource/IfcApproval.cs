...
{
	[EntityName("IFCAPPROVAL")]
	public  partial class @IfcApproval : INotifyPropertyChanged, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _approvalDateTime;
		...
		{ 
			get 
			{
				if(IsActivated) return _approvalStatus;
		...
		{ 
			get 
			{
				if(IsActivated) return _approvalLevel;
		...
		{ 
			get 
			{
				if(IsActivated) return _approvalQualifier;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				case 0:
					 ...
					 break;
				case 1:
					 @ApprovalDateTime = (IfcDateTimeSelect)value;
					 break;
				case 2:
					 @ApprovalStatus = (IfcLabel?)value;
					 break;
				case 3:
					 @ApprovalLevel = (IfcLabel?)value;
					 break;
				case 4:
					 @ApprovalQualifier = (IfcText?)value;
					 break;
				case 5:
