...
{
	[EntityName("IFCSURFACESTYLESHADING")]
	public  partial class @IfcSurfaceStyleShading : INotifyPropertyChanged, IfcSurfaceStyleElementSelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _surfaceColour;
