...
{
	[EntityName("IFCTEXTSTYLETEXTMODEL")]
	public  partial class @IfcTextStyleTextModel : INotifyPropertyChanged, IfcTextStyleSelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _textIndent;
		...
		{ 
			get 
			{
				if(IsActivated) return _textAlign;
		...
		{ 
			get 
			{
				if(IsActivated) return _textDecoration;
		...
		{ 
			get 
			{
				if(IsActivated) return _letterSpacing;
		...
		{ 
			get 
			{
				if(IsActivated) return _wordSpacing;
		...
		{ 
			get 
			{
				if(IsActivated) return _textTransform;
		...
		{ 
			get 
			{
				if(IsActivated) return _lineHeight;
