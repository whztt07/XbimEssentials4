...
namespace Xbim.Ifc4.MaterialResource
{
	...
	public  partial class @IfcMaterialList : INotifyPropertyChanged, IfcMaterialSelect, IInstantiableEntity, IEqualityComparer<@IfcMaterialList>, IEquatable<@IfcMaterialList>
	{
		...
		internal IfcMaterialList(IModel model) 		{ 
			Model = model; 
			_materials = new ItemSet<IfcMaterial>( this, 0 );
		}
		...
		{ 
			get 
			{
				if(ActivationStatus != ActivationStatus.NotActivated) return _materials;
