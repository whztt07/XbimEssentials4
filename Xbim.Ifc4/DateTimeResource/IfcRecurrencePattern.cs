...
{
	[EntityName("IFCRECURRENCEPATTERN", 499)]
	...
	public  partial class @IfcRecurrencePattern : INotifyPropertyChanged, IInstantiableEntity
	{
		...
		internal IfcRecurrencePattern(IModel model) 		{ 
			Model = model; 
			_dayComponent = new ItemSet<IfcDayInMonthNumber>( this );
			_weekdayComponent = new ItemSet<IfcDayInWeekNumber>( this );
			_monthComponent = new ItemSet<IfcMonthInYearNumber>( this );
			_timePeriods = new ItemSet<IfcTimePeriod>( this );
		}
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			switch (propIndex)
			{
				case 0: 
					...
					return;
				case 1: 
					if (_dayComponent == null) _dayComponent = new ItemSet<IfcDayInMonthNumber>( this );
					_dayComponent.InternalAdd(value.IntegerVal);
					return;
				case 2: 
					if (_weekdayComponent == null) _weekdayComponent = new ItemSet<IfcDayInWeekNumber>( this );
					_weekdayComponent.InternalAdd(value.IntegerVal);
					return;
				case 3: 
					if (_monthComponent == null) _monthComponent = new ItemSet<IfcMonthInYearNumber>( this );
				...
				case 6: 
					...
					return;
				case 7: 
					if (_timePeriods == null) _timePeriods = new ItemSet<IfcTimePeriod>( this );
