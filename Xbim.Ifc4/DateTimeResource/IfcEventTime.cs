...
namespace Xbim.Ifc4.DateTimeResource
{
	...
	public  partial class @IfcEventTime : IfcSchedulingTime, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _actualDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _earlyDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _lateDate;
		...
		{ 
			get 
			{
				if(IsActivated) return _scheduleDate;
