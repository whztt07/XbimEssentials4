...
{
	[EntityName("IFCPROPERTYTABLEVALUE")]
	public  partial class @IfcPropertyTableValue : IfcSimpleProperty, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _definingValues;
		...
		{ 
			get 
			{
				if(IsActivated) return _definedValues;
		...
		{ 
			get 
			{
				if(IsActivated) return _definingUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _definedUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _curveInterpolation;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 6:
					 ...
					 break;
				case 7:
					 @CurveInterpolation = (IfcCurveInterpolationEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
