...
{
	public partial struct IfcPHMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcPHMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcPHMeasure(float value)
        {
            return new IfcPHMeasure(value);
        }

        public static implicit operator float(IfcPHMeasure obj)
        {
