...
{
	public partial struct IfcWarpingConstantMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcWarpingConstantMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcWarpingConstantMeasure(float value)
        {
            return new IfcWarpingConstantMeasure(value);
        }

        public static implicit operator float(IfcWarpingConstantMeasure obj)
        {
