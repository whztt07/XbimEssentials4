...
{
	public partial struct IfcSectionalAreaIntegralMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcSectionalAreaIntegralMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSectionalAreaIntegralMeasure(float value)
        {
            return new IfcSectionalAreaIntegralMeasure(value);
        }

        public static implicit operator float(IfcSectionalAreaIntegralMeasure obj)
        {
