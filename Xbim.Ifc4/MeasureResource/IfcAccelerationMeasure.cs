...
namespace Xbim.Ifc4.MeasureResource
{
	...
	{ 
        ...
        public IfcAccelerationMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcAccelerationMeasure(float value)
        {
            return new IfcAccelerationMeasure(value);
        }

        public static implicit operator float(IfcAccelerationMeasure obj)
        {
