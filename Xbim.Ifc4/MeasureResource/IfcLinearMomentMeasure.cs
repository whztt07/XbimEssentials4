...
{
	public partial struct IfcLinearMomentMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcLinearMomentMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcLinearMomentMeasure(float value)
        {
            return new IfcLinearMomentMeasure(value);
        }

        public static implicit operator float(IfcLinearMomentMeasure obj)
        {
