...
{
	public partial struct IfcDoseEquivalentMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcDoseEquivalentMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcDoseEquivalentMeasure(float value)
        {
            return new IfcDoseEquivalentMeasure(value);
        }

        public static implicit operator float(IfcDoseEquivalentMeasure obj)
        {
