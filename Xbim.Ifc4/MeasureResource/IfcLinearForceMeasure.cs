...
{
	public partial struct IfcLinearForceMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcLinearForceMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcLinearForceMeasure(float value)
        {
            return new IfcLinearForceMeasure(value);
        }

        public static implicit operator float(IfcLinearForceMeasure obj)
        {
