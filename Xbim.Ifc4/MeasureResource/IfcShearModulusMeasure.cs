...
{
	public partial struct IfcShearModulusMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcShearModulusMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcShearModulusMeasure(float value)
        {
            return new IfcShearModulusMeasure(value);
        }

        public static implicit operator float(IfcShearModulusMeasure obj)
        {
