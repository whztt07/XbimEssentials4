...
{
	public partial struct IfcAmountOfSubstanceMeasure : IfcMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcAmountOfSubstanceMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcAmountOfSubstanceMeasure(float value)
        {
            return new IfcAmountOfSubstanceMeasure(value);
        }

        public static implicit operator float(IfcAmountOfSubstanceMeasure obj)
        {
