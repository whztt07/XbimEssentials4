...
{
	public partial struct IfcParameterValue : IfcMeasureValue, IfcTrimmingSelect, IExpressSelectType
	{ 
        ...
        public IfcParameterValue(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcParameterValue(float value)
        {
            return new IfcParameterValue(value);
        }

        public static implicit operator float(IfcParameterValue obj)
        {
