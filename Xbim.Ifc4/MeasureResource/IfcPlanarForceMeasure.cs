...
{
	public partial struct IfcPlanarForceMeasure : IfcDerivedMeasureValue, IExpressSelectType
	{ 
        ...
        public IfcPlanarForceMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcPlanarForceMeasure(float value)
        {
            return new IfcPlanarForceMeasure(value);
        }

        public static implicit operator float(IfcPlanarForceMeasure obj)
        {
