...
{
	public partial struct IfcModulusOfRotationalSubgradeReactionMeasure : IfcDerivedMeasureValue, IfcModulusOfRotationalSubgradeReactionSelect, IExpressSelectType
	{ 
        ...
        public IfcModulusOfRotationalSubgradeReactionMeasure(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcModulusOfRotationalSubgradeReactionMeasure(float value)
        {
            return new IfcModulusOfRotationalSubgradeReactionMeasure(value);
        }

        public static implicit operator float(IfcModulusOfRotationalSubgradeReactionMeasure obj)
        {
