...
{
	[ExpressType("IFCSHADINGDEVICE", 976)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcShadingDevice : IfcBuildingElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcShadingDevice>, System.IEquatable<@IfcShadingDevice>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcShadingDevice(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcShadingDevice
            var root = (@IfcShadingDevice)obj;
            return this == root;
        }
        ...
        public static bool operator ==(@IfcShadingDevice left, @IfcShadingDevice right)
        {
