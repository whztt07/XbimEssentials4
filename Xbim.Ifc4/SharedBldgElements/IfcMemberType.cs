...
{
	[ExpressType("IFCMEMBERTYPE", 767)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcMemberType : IfcBuildingElementType, IInstantiableEntity, IEqualityComparer<@IfcMemberType>, IEquatable<@IfcMemberType>
	{
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcMemberTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
