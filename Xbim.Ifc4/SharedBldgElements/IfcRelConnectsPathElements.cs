...
namespace Xbim.Ifc4.SharedBldgElements
{
	...
	public  partial class @IfcRelConnectsPathElements : IfcRelConnectsElements, IInstantiableEntity
	{
		...
		internal IfcRelConnectsPathElements(IModel model) : base(model) 		{ 
			Model = model; 
			_relatingPriorities = new ItemSet<double>( model );
			_relatedPriorities = new ItemSet<double>( model );
		}
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 6:
					 ...
					 break;
				case 7:
					 @RelatingPriorities.Add((double)value);
					 break;
				case 8:
					 @RelatedPriorities.Add((double)value);
					 break;
				case 9:
