...
{
	[ExpressType("IFCBEAMTYPE", 430)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcBeamType : IfcBuildingElementType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcBeamType>, System.IEquatable<@IfcBeamType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcBeamType(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public static bool operator ==(@IfcBeamType left, @IfcBeamType right)
        {
