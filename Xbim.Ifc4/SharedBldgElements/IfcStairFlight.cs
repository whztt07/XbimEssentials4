...
namespace Xbim.Ifc4.SharedBldgElements
{
	...
	public  partial class @IfcStairFlight : IfcBuildingElement, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _numberOfRiser;
		...
		{ 
			get 
			{
				if(IsActivated) return _numberOfTreads;
		...
		{ 
			get 
			{
				if(IsActivated) return _riserHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _treadLength;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 7:
					 ...
					 break;
				case 8:
					 @NumberOfRiser = (int?)value;
					 break;
				case 9:
					 @NumberOfTreads = (int?)value;
					 break;
				case 10:
				...
				case 11:
					 ...
					 break;
				case 12:
					 @PredefinedType = (IfcStairFlightTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
