...
{
	[ExpressType("IFCCOLUMNTYPE", 495)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcColumnType : IfcBuildingElementType, IInstantiableEntity, IEqualityComparer<@IfcColumnType>, IEquatable<@IfcColumnType>
	{
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcColumnTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcColumnType
            var root = (@IfcColumnType)obj;
            return this == root;
        }
