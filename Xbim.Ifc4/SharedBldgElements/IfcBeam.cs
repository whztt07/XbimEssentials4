...
namespace Xbim.Ifc4.SharedBldgElements
{
	...
	public  partial class @IfcBeam : IfcBuildingElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcBeam>, System.IEquatable<@IfcBeam>
	{
		...
		/*CorrectPredefinedType:                               ((PredefinedType = IfcBeamTypeEnum.USERDEFINED) AND EXISTS (SELF\IfcObject.ObjectType));*/
		/*CorrectTypeAssigned:                                ('IFC4.IFCBEAMTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));*/
		}
		#endregion
