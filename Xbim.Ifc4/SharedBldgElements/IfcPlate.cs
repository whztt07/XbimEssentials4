...
namespace Xbim.Ifc4.SharedBldgElements
{
	...
	public  partial class @IfcPlate : IfcBuildingElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcPlate>, System.IEquatable<@IfcPlate>
	{
		...
		/*CorrectPredefinedType:                               ((PredefinedType = IfcPlateTypeEnum.USERDEFINED) AND EXISTS (SELF\IfcObject.ObjectType));*/
		/*CorrectTypeAssigned:                                ('IFC4.IFCPLATETYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));*/
		}
		#endregion
        ...
        public static bool operator ==(@IfcPlate left, @IfcPlate right)
        {
