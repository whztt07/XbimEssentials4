...
{
	[ExpressType("IFCBUILDINGELEMENTPROXYTYPE", 452)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcBuildingElementProxyType : IfcBuildingElementType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcBuildingElementProxyType>, System.IEquatable<@IfcBuildingElementProxyType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcBuildingElementProxyType(IModel model) : base(model) 		{ 
			Model = model; 
		}
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcBuildingElementProxyTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcBuildingElementProxyType
            var root = (@IfcBuildingElementProxyType)obj;
            return this == root;
        }
