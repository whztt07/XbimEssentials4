...
{
	public partial struct IfcSpecularRoughness : IfcSpecularHighlightSelect, IExpressSelectType
	{ 
        ...
        public IfcSpecularRoughness(float val)
        {
            _theValue = val;
        }

        public static implicit operator IfcSpecularRoughness(float value)
        {
            return new IfcSpecularRoughness(value);
        }

        public static implicit operator float(IfcSpecularRoughness obj)
        {
