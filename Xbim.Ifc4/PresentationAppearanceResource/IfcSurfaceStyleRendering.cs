...
{
	[EntityName("IFCSURFACESTYLERENDERING")]
	public  partial class @IfcSurfaceStyleRendering : IfcSurfaceStyleShading, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _transparency;
		...
		{ 
			get 
			{
				if(IsActivated) return _diffuseColour;
		...
		{ 
			get 
			{
				if(IsActivated) return _transmissionColour;
		...
		{ 
			get 
			{
				if(IsActivated) return _diffuseTransmissionColour;
		...
		{ 
			get 
			{
				if(IsActivated) return _reflectionColour;
		...
		{ 
			get 
			{
				if(IsActivated) return _specularColour;
		...
		{ 
			get 
			{
				if(IsActivated) return _specularHighlight;
		...
		{ 
			get 
			{
				if(IsActivated) return _reflectanceMethod;
