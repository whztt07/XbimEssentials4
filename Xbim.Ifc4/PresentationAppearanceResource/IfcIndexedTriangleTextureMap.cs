...
{
	[EntityName("IFCINDEXEDTRIANGLETEXTUREMAP")]
	public  partial class @IfcIndexedTriangleTextureMap : IfcIndexedTextureMap, IInstantiableEntity
	{
		...
		internal IfcIndexedTriangleTextureMap(IModel model) : base(model) 		{ 
			Model = model; 
			_texCoordIndex = new ItemSet<ItemSet<int>>( model );
		}

		#region Explicit attribute fields
		private ItemSet<ItemSet<int>> _texCoordIndex;
		#endregion
	
		#region Explicit attribute properties
		[EntityAttribute(3, EntityAttributeState.Optional)]
		public ItemSet<ItemSet<int>> @TexCoordIndex 
		{ 
			get 
			{
				if(IsActivated) return _texCoordIndex;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 2:
					 ...
					 break;
				case 3:
					 @TexCoordIndex = (ItemSet<ItemSet<int>>)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
