...
namespace Xbim.Ifc4.PresentationAppearanceResource
{
	...
	public  partial class @IfcPresentationStyleAssignment : IPersistEntity, INotifyPropertyChanged, IfcStyleAssignmentSelect, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcPresentationStyleAssignment>, System.IEquatable<@IfcPresentationStyleAssignment>
	{
		...
		internal IfcPresentationStyleAssignment(IModel model) 		{ 
			Model = model; 
			_styles = new ItemSet<IfcPresentationStyleSelect>( this );
		}
		...
		public virtual void Parse(int propIndex, IPropertyValue value)
		{
			...
			{
				case 0: 
					if (_styles == null) _styles = new ItemSet<IfcPresentationStyleSelect>( this );
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcPresentationStyleAssignment
            var root = (@IfcPresentationStyleAssignment)obj;
            return this == root;
        }
