...
namespace Xbim.Ifc4.UtilityResource
{
	...
	public  partial class @IfcApplication : INotifyPropertyChanged, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _applicationDeveloper;
		...
		{ 
			get 
			{
				if(IsActivated) return _applicationFullName;
		...
		{ 
			get 
			{
				if(IsActivated) return _applicationIdentifier;
