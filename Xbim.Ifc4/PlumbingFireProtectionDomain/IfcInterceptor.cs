...
namespace Xbim.Ifc4.PlumbingFireProtectionDomain
{
	...
	public  partial class @IfcInterceptor : IfcFlowTreatmentDevice, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcInterceptor>, System.IEquatable<@IfcInterceptor>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcInterceptor(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcInterceptor
            var root = (@IfcInterceptor)obj;
            return this == root;
        }
        ...
        public static bool operator ==(@IfcInterceptor left, @IfcInterceptor right)
        {
