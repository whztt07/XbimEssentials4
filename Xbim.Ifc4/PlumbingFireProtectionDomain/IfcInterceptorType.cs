...
{
	[EntityName("IFCINTERCEPTORTYPE", 320)]
	public  partial class @IfcInterceptorType : IfcFlowTreatmentDeviceType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcInterceptorTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
