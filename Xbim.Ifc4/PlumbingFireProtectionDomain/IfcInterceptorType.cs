...
namespace Xbim.Ifc4.PlumbingFireProtectionDomain
{
	...
	public  partial class @IfcInterceptorType : IfcFlowTreatmentDeviceType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcInterceptorType>, System.IEquatable<@IfcInterceptorType>
	{
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcInterceptorTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcInterceptorType
            var root = (@IfcInterceptorType)obj;
            return this == root;
        }
