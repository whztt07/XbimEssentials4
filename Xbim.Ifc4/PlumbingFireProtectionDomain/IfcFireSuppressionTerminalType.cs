...
{
	[ExpressType("IFCFIRESUPPRESSIONTERMINALTYPE", 663)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcFireSuppressionTerminalType : IfcFlowTerminalType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcFireSuppressionTerminalType>, System.IEquatable<@IfcFireSuppressionTerminalType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcFireSuppressionTerminalType(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcFireSuppressionTerminalType
            var root = (@IfcFireSuppressionTerminalType)obj;
            return this == root;
        }
        ...
        public static bool operator ==(@IfcFireSuppressionTerminalType left, @IfcFireSuppressionTerminalType right)
        {
