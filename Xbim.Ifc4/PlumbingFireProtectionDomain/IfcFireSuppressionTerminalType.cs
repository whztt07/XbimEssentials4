...
{
	[EntityName("IFCFIRESUPPRESSIONTERMINALTYPE", 272)]
	public  partial class @IfcFireSuppressionTerminalType : IfcFlowTerminalType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcFireSuppressionTerminalTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
