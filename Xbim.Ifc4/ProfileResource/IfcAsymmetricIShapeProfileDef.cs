...
{
	[EntityName("IFCASYMMETRICISHAPEPROFILEDEF")]
	public  partial class @IfcAsymmetricIShapeProfileDef : IfcParameterizedProfileDef, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _bottomFlangeWidth;
		...
		{ 
			get 
			{
				if(IsActivated) return _overallDepth;
		...
		{ 
			get 
			{
				if(IsActivated) return _bottomFlangeThickness;
		...
		{ 
			get 
			{
				if(IsActivated) return _bottomFlangeFilletRadius;
		...
		{ 
			get 
			{
				if(IsActivated) return _topFlangeWidth;
		...
		{ 
			get 
			{
				if(IsActivated) return _topFlangeThickness;
		...
		{ 
			get 
			{
				if(IsActivated) return _topFlangeFilletRadius;
		...
		{ 
			get 
			{
				if(IsActivated) return _bottomFlangeEdgeRadius;
		...
		{ 
			get 
			{
				if(IsActivated) return _bottomFlangeSlope;
		...
		{ 
			get 
			{
				if(IsActivated) return _topFlangeEdgeRadius;
		...
		{ 
			get 
			{
				if(IsActivated) return _topFlangeSlope;
