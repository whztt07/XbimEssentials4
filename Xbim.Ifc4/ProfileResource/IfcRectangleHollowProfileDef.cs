...
{
	[EntityName("IFCRECTANGLEHOLLOWPROFILEDEF")]
	public  partial class @IfcRectangleHollowProfileDef : IfcRectangleProfileDef, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _wallThickness;
		...
		{ 
			get 
			{
				if(IsActivated) return _innerFilletRadius;
		...
		{ 
			get 
			{
				if(IsActivated) return _outerFilletRadius;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 5:
					 ...
					 break;
				case 6:
					 @InnerFilletRadius = (IfcNonNegativeLengthMeasure?)value;
					 break;
				case 7:
					 @OuterFilletRadius = (IfcNonNegativeLengthMeasure?)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
