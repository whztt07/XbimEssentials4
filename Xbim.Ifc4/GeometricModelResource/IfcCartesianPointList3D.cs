...
{
	[EntityName("IFCCARTESIANPOINTLIST3D")]
	public  partial class @IfcCartesianPointList3D : IfcCartesianPointList, IInstantiableEntity
	{
		...
		internal IfcCartesianPointList3D(IModel model) : base(model) 		{ 
			Model = model; 
			_coordList = new ItemSet<ItemSet<IfcLengthMeasure>>( model );
		}
		...
		{ 
			get 
			{
				if(IsActivated) return _coordList;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			...
			{
				case 0:
					 @CoordList = (ItemSet<ItemSet<IfcLengthMeasure>>)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
