...
{
	[EntityName("IFCVIRTUALGRIDINTERSECTION")]
	public  partial class @IfcVirtualGridIntersection : INotifyPropertyChanged, IfcGridPlacementDirectionSelect, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _intersectingAxes;
		...
		{ 
			get 
			{
				if(IsActivated) return _offsetDistances;
