...
{
	[EntityName("IFCTENDONANCHORTYPE", 697)]
	public  partial class @IfcTendonAnchorType : IfcReinforcingElementType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcTendonAnchorTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
