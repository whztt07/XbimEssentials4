...
{
	[EntityName("IFCTENDONANCHOR", 696)]
	public  partial class @IfcTendonAnchor : IfcReinforcingElement, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 @PredefinedType = (IfcTendonAnchorTypeEnum?)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
		...
		#region Where rules
		/*CorrectPredefinedType:                              ((PredefinedType = IfcTendonAnchorTypeEnum.USERDEFINED) AND EXISTS (SELF\IfcObject.ObjectType));*/
