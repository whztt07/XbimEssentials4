...
{
	[EntityName("IFCLIGHTSOURCEPOSITIONAL")]
	public  partial class @IfcLightSourcePositional : IfcLightSource, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _constantAttenuation;
		...
		{ 
			get 
			{
				if(IsActivated) return _distanceAttenuation;
		...
		{ 
			get 
			{
				if(IsActivated) return _quadricAttenuation;
