...
{
	[ExpressType("IFCACTUATOR", 394)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcActuator : IfcDistributionControlElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcActuator>, System.IEquatable<@IfcActuator>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcActuator(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public static bool operator ==(@IfcActuator left, @IfcActuator right)
        {
