...
{
	[ExpressType("IFCALARM", 406)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcAlarm : IfcDistributionControlElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcAlarm>, System.IEquatable<@IfcAlarm>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcAlarm(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public static bool operator ==(@IfcAlarm left, @IfcAlarm right)
        {
