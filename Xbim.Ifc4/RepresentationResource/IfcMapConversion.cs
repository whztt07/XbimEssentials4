...
namespace Xbim.Ifc4.RepresentationResource
{
	...
	public  partial class @IfcMapConversion : IfcCoordinateOperation, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _eastings;
		...
		{ 
			get 
			{
				if(IsActivated) return _northings;
		...
		{ 
			get 
			{
				if(IsActivated) return _orthogonalHeight;
		...
		{ 
			get 
			{
				if(IsActivated) return _xAxisAbscissa;
		...
		{ 
			get 
			{
				if(IsActivated) return _xAxisOrdinate;
