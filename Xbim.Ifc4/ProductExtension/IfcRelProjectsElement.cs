...
{
	[EntityName("IFCRELPROJECTSELEMENT")]
	public  partial class @IfcRelProjectsElement : IfcRelDecomposes, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _relatedFeatureElement;
