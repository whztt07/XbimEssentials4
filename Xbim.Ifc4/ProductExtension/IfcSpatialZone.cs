...
{
	[ExpressType("IFCSPATIALZONE", 1001)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcSpatialZone : IfcSpatialElement, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcSpatialZone>, System.IEquatable<@IfcSpatialZone>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcSpatialZone(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcSpatialZone
            var root = (@IfcSpatialZone)obj;
            return this == root;
        }
        ...
        public static bool operator ==(@IfcSpatialZone left, @IfcSpatialZone right)
        {
