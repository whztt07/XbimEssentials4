...
{
	[EntityName("IFCRELASSIGNSTOPRODUCT")]
	public  partial class @IfcRelAssignsToProduct : IfcRelAssigns, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _relatingProduct;
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 5:
					 ...
					 break;
				case 6:
					 @RelatingProduct = (IfcProductSelect)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
		...
		#region Where rules
		/*NoSelfReference:	NoSelfReference : SIZEOF(QUERY(Temp <* SELF\IfcRelAssigns.RelatedObjects | RelatingProduct :=: Temp)) = 0;*/
		#endregion
