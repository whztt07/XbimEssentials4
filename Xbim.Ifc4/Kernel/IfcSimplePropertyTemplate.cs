...
{
	[EntityName("IFCSIMPLEPROPERTYTEMPLATE")]
	public  partial class @IfcSimplePropertyTemplate : IfcPropertyTemplate, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _templateType;
		...
		{ 
			get 
			{
				if(IsActivated) return _primaryMeasureType;
		...
		{ 
			get 
			{
				if(IsActivated) return _secondaryMeasureType;
		...
		{ 
			get 
			{
				if(IsActivated) return _enumerators;
		...
		{ 
			get 
			{
				if(IsActivated) return _primaryUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _secondaryUnit;
		...
		{ 
			get 
			{
				if(IsActivated) return _accessState;
