...
{
	[ExpressType("IFCEVAPORATORTYPE", 627)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcEvaporatorType : IfcEnergyConversionDeviceType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcEvaporatorType>, System.IEquatable<@IfcEvaporatorType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcEvaporatorType(IModel model) : base(model) 		{ 
			Model = model; 
		}
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcEvaporatorTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcEvaporatorType
            var root = (@IfcEvaporatorType)obj;
            return this == root;
        }
