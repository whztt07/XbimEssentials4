...
{
	[ExpressType("IFCHUMIDIFIER", 703)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcHumidifier : IfcEnergyConversionDevice, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcHumidifier>, System.IEquatable<@IfcHumidifier>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcHumidifier(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcHumidifier
            var root = (@IfcHumidifier)obj;
            return this == root;
        }
