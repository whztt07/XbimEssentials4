...
{
	[ExpressType("IFCFLOWMETER", 671)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcFlowMeter : IfcFlowController, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcFlowMeter>, System.IEquatable<@IfcFlowMeter>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcFlowMeter(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcFlowMeter
            var root = (@IfcFlowMeter)obj;
            return this == root;
        }
        ...
        public static bool operator ==(@IfcFlowMeter left, @IfcFlowMeter right)
        {
