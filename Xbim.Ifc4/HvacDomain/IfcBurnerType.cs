...
{
	[ExpressType("IFCBURNERTYPE", 457)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcBurnerType : IfcEnergyConversionDeviceType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcBurnerType>, System.IEquatable<@IfcBurnerType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcBurnerType(IModel model) : base(model) 		{ 
			Model = model; 
		}
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcBurnerTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcBurnerType
            var root = (@IfcBurnerType)obj;
            return this == root;
        }
