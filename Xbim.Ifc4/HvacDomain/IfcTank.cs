...
{
	[ExpressType("IFCTANK", 1079)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcTank : IfcFlowStorageDevice, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcTank>, System.IEquatable<@IfcTank>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcTank(IModel model) : base(model) 		{ 
			Model = model; 
		}
		...
		/*CorrectPredefinedType:                               ((PredefinedType = IfcTankTypeEnum.USERDEFINED) AND EXISTS (SELF\IfcObject.ObjectType));*/
		/*CorrectTypeAssigned:                                ('IFC4.IFCTANKTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));*/
		}
		#endregion
