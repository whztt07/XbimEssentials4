...
{
	[ExpressType("IFCVALVE", 1127)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcValve : IfcFlowController, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcValve>, System.IEquatable<@IfcValve>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcValve(IModel model) : base(model) 		{ 
			Model = model; 
		}
        ...
        public static bool operator ==(@IfcValve left, @IfcValve right)
        {
