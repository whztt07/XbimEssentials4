...
{
	[ExpressType("IFCCOOLEDBEAMTYPE", 533)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcCooledBeamType : IfcEnergyConversionDeviceType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcCooledBeamType>, System.IEquatable<@IfcCooledBeamType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcCooledBeamType(IModel model) : base(model) 		{ 
			Model = model; 
		}
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcCooledBeamTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcCooledBeamType
            var root = (@IfcCooledBeamType)obj;
            return this == root;
        }
