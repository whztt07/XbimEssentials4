...
{
	[ExpressType("IFCCOOLINGTOWER", 534)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcCoolingTower : IfcEnergyConversionDevice, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcCoolingTower>, System.IEquatable<@IfcCoolingTower>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcCoolingTower(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcCoolingTower
            var root = (@IfcCoolingTower)obj;
            return this == root;
        }
