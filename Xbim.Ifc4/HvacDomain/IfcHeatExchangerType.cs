...
{
	[EntityName("IFCHEATEXCHANGERTYPE", 311)]
	public  partial class @IfcHeatExchangerType : IfcEnergyConversionDeviceType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcHeatExchangerTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
		...
		#region Where rules
		/*CorrectPredefinedType:                              ((PredefinedType = IfcHeatExchangerTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		#endregion
