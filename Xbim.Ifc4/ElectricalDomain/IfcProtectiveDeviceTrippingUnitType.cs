...
{
	[EntityName("IFCPROTECTIVEDEVICETRIPPINGUNITTYPE", 475)]
	public  partial class @IfcProtectiveDeviceTrippingUnitType : IfcDistributionControlElementType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcProtectiveDeviceTrippingUnitTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
