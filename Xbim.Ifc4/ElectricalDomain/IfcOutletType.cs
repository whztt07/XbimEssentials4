...
{
	[ExpressType("IFCOUTLETTYPE", 789)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcOutletType : IfcFlowTerminalType, IInstantiableEntity, IEqualityComparer<@IfcOutletType>, IEquatable<@IfcOutletType>
	{
		...
		/*CorrectPredefinedType:                              ((PredefinedType = IfcOutletTypeEnum.USERDEFINED) AND EXISTS(SELF\IfcElementType.ElementType));*/
		}
		#endregion
