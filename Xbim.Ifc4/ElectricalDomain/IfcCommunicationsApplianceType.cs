...
{
	[EntityName("IFCCOMMUNICATIONSAPPLIANCETYPE", 106)]
	public  partial class @IfcCommunicationsApplianceType : IfcFlowTerminalType, IInstantiableEntity
	{
		...
		void IInstantiableEntity.SetValue(int index, object value)
		{
			switch(index)
			{
				...
				case 8:
					 ...
					 break;
				case 9:
					 if (value != null) @PredefinedType = (IfcCommunicationsApplianceTypeEnum)value;
					 break;
				default:
					throw new System.IndexOutOfRangeException();
			}
