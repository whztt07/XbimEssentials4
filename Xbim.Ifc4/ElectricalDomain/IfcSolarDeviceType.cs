...
{
	[ExpressType("IFCSOLARDEVICETYPE", 991)]
	// ReSharper disable once PartialTypeWithSinglePart
	public  partial class @IfcSolarDeviceType : IfcEnergyConversionDeviceType, IInstantiableEntity, System.Collections.Generic.IEqualityComparer<@IfcSolarDeviceType>, System.IEquatable<@IfcSolarDeviceType>
	{
		//internal constructor makes sure that objects are not created outside of the model/ assembly controlled area
		internal IfcSolarDeviceType(IModel model) : base(model) 		{ 
			Model = model; 
		}
	    ...
	    public override bool Equals(object obj)
        {
            ...
            // Cast as @IfcSolarDeviceType
            var root = (@IfcSolarDeviceType)obj;
            return this == root;
        }
