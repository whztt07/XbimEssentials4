...
{
	[EntityName("IFCFAILURECONNECTIONCONDITION")]
	public  partial class @IfcFailureConnectionCondition : IfcStructuralConnectionCondition, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _tensionFailureX;
		...
		{ 
			get 
			{
				if(IsActivated) return _tensionFailureY;
		...
		{ 
			get 
			{
				if(IsActivated) return _tensionFailureZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _compressionFailureX;
		...
		{ 
			get 
			{
				if(IsActivated) return _compressionFailureY;
		...
		{ 
			get 
			{
				if(IsActivated) return _compressionFailureZ;
