...
{
	[EntityName("IFCSURFACEREINFORCEMENTAREA")]
	public  partial class @IfcSurfaceReinforcementArea : IfcStructuralLoadOrResult, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _surfaceReinforcement1;
		...
		{ 
			get 
			{
				if(IsActivated) return _surfaceReinforcement2;
		...
		{ 
			get 
			{
				if(IsActivated) return _shearReinforcement;
