...
{
	[EntityName("IFCSTRUCTURALLOADSINGLEFORCE")]
	public  partial class @IfcStructuralLoadSingleForce : IfcStructuralLoadStatic, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _momentX;
		...
		{ 
			get 
			{
				if(IsActivated) return _momentY;
		...
		{ 
			get 
			{
				if(IsActivated) return _momentZ;
