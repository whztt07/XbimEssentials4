...
{
	[EntityName("IFCBOUNDARYEDGECONDITION")]
	public  partial class @IfcBoundaryEdgeCondition : IfcBoundaryCondition, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _translationalStiffnessByLengthX;
		...
		{ 
			get 
			{
				if(IsActivated) return _translationalStiffnessByLengthY;
		...
		{ 
			get 
			{
				if(IsActivated) return _translationalStiffnessByLengthZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalStiffnessByLengthX;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalStiffnessByLengthY;
		...
		{ 
			get 
			{
				if(IsActivated) return _rotationalStiffnessByLengthZ;
