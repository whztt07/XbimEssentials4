...
{
	[EntityName("IFCSTRUCTURALLOADLINEARFORCE")]
	public  partial class @IfcStructuralLoadLinearForce : IfcStructuralLoadStatic, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _linearForceX;
		...
		{ 
			get 
			{
				if(IsActivated) return _linearForceY;
		...
		{ 
			get 
			{
				if(IsActivated) return _linearForceZ;
		...
		{ 
			get 
			{
				if(IsActivated) return _linearMomentX;
		...
		{ 
			get 
			{
				if(IsActivated) return _linearMomentY;
		...
		{ 
			get 
			{
				if(IsActivated) return _linearMomentZ;
