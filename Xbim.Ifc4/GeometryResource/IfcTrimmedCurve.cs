...
namespace Xbim.Ifc4.GeometryResource
{
	...
	public  partial class @IfcTrimmedCurve : IfcBoundedCurve, IInstantiableEntity
	{
		...
		{ 
			get 
			{
				if(IsActivated) return _senseAgreement;
		...
		{ 
			get 
			{
				if(IsActivated) return _masterRepresentation;
